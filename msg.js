...
define([
  //>>excludeStart('excludeMsg', pragmas.excludeMsg)
  'module', 'messageformat', 'underscore'
  //>>excludeEnd('excludeMsg')
  ], function (
  //>>excludeStart('excludeMsg', pragmas.excludeMsg)
    ...
    text = {
        ...
        load: function (name, req, onLoad, config) {
            ...
            var parsed = text.parseName(name),
                nonStripName = config.msg.i18nLocation + '/' + config.locale + '/' + parsed.moduleName + '.' + parsed.ext,
                url = req.toUrl(nonStripName),
                useXhr = (masterConfig.useXhr) ||
                         text.useXhr;

            localeEmitter = req.toUrl(config.msg.i18nLocation + '/' + '{{locale}}/locale.js');
                    ...
                    if (status > 399 && status < 600) {
                      ...
                      if(!MessageFormat.locale[globalConfig.locale]) {
                        require([localeEmitter.replace('{{locale}}', globalConfig.locale)], function (locale) {
                          ...
                          var mf = new MessageFormat(globalConfig.locale);
                          var returnee = {};
                          _.each(JSON.parse(xhr.responseText), function (msg, key) {
